...
import com.februy.shop.commonweb.security.endpoint.JWTAuthenticationEntryPoint;
import com.februy.shop.commonweb.security.filter.JWTAuthenticationTokenFilter;
...
public class SecurityConfig extends  WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .antMatchers(HttpMethod.POST,"/users/test").permitAll()
                //允许访问Druid监控
